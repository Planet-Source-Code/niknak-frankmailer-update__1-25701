...
Begin VB.Form frm_main 
   ...
   Begin TabDlg.SSTab tab_mailer 
      ...
      Tab(0).Control(0)=   "fra_msgbody"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "fra_msgto"
      ...
      TabCaption(2)   =   "About Frankmailer"
      TabPicture(2)   =   "frm_main.frx":2D32
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "img_splash"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "lbl_bugreport"
      ...
      Begin VB.Frame fra_msgbody 
         ...
         Begin VB.Image img_msgbody 
            Height          =   480
            Left            =   120
            Picture         =   "frm_main.frx":AF28
            Top             =   300
            Width           =   480
         End
      End
      Begin VB.Label lbl_bugreport 
         Alignment       =   2  'Center
...
'**********************************
    ...
    Private Sub lbl_bugreport_Click()
